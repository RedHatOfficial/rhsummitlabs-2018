...
image:postman/environment-config.png[Environment Config, width="100%"]
...
image:postman/import-collection.png[Summit Collection Import, width="100%"]
...
image:postman/postman-collection.png[BPM Postman Collection, width="100%"]
.. Click on the 'Summit BPM Postman Collection' and it should expand, click on the folder to view the underlying API Requests +
image:postman/postman-collection-expanded.png[BPM Postman Collection Expanded, width="100%"]
