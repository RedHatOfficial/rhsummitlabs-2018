...
3Scale is available as both SaaS and on premise options. Today we will be using an account on the SaaS platform at 3scale.net.

In this lab we will be using the

* Login to 3Scale SaaS platform
* werwe
* werwr
