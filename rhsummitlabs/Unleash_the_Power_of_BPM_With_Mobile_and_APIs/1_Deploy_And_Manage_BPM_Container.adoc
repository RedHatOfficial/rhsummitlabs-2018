...
- Firstly we set a host environment variable
[source,sh]
----
# IF USING BPM SERVER 1
export HOST = ec2-34-251-130-28.eu-west-1.compute.amazonaws.com:8080

# IF USING BPM SERVER 2
export HOST = ec2-52-51-30-91.eu-west-1.compute.amazonaws.com:8080
----
...
[source,sh]
----
curl -X GET --user <USER_ID>:'<USER_PWD>' http://$HOST/kie-server/services/rest/server
----
...
curl -X PUT \
  --user <USER_ID>:'<USER_PWD>' http://$HOST/kie-server/services/rest/server/containers/$ALIAS \
...
----
curl -X GET \
  --user <USER_ID>:'<USER_PWD>' http://$HOST/kie-server/services/rest/server/containers
----
...
NOTE: The whole KIE REST API can be reviewed at: http://$HOST/kie-server/docs/index.html
...
curl -X GET \
  http://$HOST/kie-server/services/rest/server/queries/processes/definitions  \
...
curl -X GET \
  http://$HOST/kie-server/services/rest/server/queries/containers/<CONTAINER_ID>/processes/definitions  \
  -H 'accept: application/json' \
  --user <USER_ID>:'<USER_PWD>'
----
...
[source,sh]
----
http://$HOST/kie-server/services/rest/server/containers/<CONTAINER_ID>/images/processes/org.jbpm.demo.NewApplication
----
...
curl -X POST --user <USER_ID>:'<USER_PWD>' \
  http://$HOST/kie-server/services/rest/server/containers/$ALIAS/processes/org.jbpm.demo.NewApplication/instances \
  -H 'cache-control: no-cache' \
  -H 'accept: application/json' \
...
[source,sh]
----
curl -X GET --user <USER_ID>:'<USER_PWD>' \
  'http://$HOST/kie-server/services/rest/server/queries/containers/<CONTAINER_ID>/process/instances?status=1&page=0&pageSize=25' \
  -H 'accept: application/json' \
  -H 'cache-control: no-cache' \
  -H 'accept: application/json'
----
...
----
curl -X GET --user <USER_ID>:'<USER_PWD>' \
  'http://$HOST/kie-server/services/rest/server/queries/tasks/instances/process/<pInstanceId> ' \
  -H 'accept: application/json' \
  -H 'cache-control: no-cache' \
  -H 'accept: application/json' \
----
...
----
curl -X POST --user <USER_ID>:'<USER_PWD>' \
  'http://$HOST/kie-server/services/rest/server/queries/tasks/instances/pot-owners ' \
  -H 'accept: application/json' \
  -H 'cache-control: no-cache' \
  -H 'accept: application/json' \
----
...
[source,sh]
----
 curl -X PUT -H "Accept: application/json" --user <USER_ID>:'<USER_PWD>' "http://$HOST/kie-server/services/rest/server/containers/<CONTAINER_ID>/tasks/<TASK_ID>/states/claimed"
----
...
[source,sh]
----
 curl -X GET -H "Accept: application/json" --user <USER_ID>:'<USER_PWD>' "http://$HOST/kie-server/services/rest/server/queries/tasks/instances/owners"
----
...
[source,sh]
----
 curl -X PUT -H "Accept: application/json" --user <USER_ID>:'<USER_PWD>' "http://$HOST/kie-server/services/rest/server/containers/<CONTAINER_ID>/tasks/<TASK_ID>/states/started"
----
...
[source,sh]
----
 curl -X PUT -H "Accept: application/json" --user <USER_ID>:'<USER_PWD>' "http://$HOST/kie-server/services/rest/server/containers/<CONTAINER_ID>/tasks/<TASK_ID>/states/completed"
----
