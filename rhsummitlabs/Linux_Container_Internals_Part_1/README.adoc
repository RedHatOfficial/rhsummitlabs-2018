...
- https://katacoda.com/fatherlinux/courses/subsystems/[Katacoda - Subsystems, Components, and Internals]
- https://docs.google.com/presentation/d/1fC9cKR2-kFW5l-VEk0Z5_1vriYpROXOXM_5rhyVnBi4/edit#slide=id.gb6f3e2d2d_2_213 - Google Slides - Linux Container Internals] 
