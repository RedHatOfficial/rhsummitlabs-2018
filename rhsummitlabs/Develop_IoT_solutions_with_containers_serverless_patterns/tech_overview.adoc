...
[.text-center]
image:icons/icon-previous.png[align=left, width=128, link=README.adoc] image:icons/icon-home.png[align="center",width=128, link=README.adoc] image:icons/icon-next.png[align="right"width=128, link=iot_usecase.adoc]
