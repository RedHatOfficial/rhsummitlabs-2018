...
* link:lab_3.adoc[*Lab 3: Create OpenWhisk Entities*]
  ...
  - link:lab_3.adoc#_organizing_resources_as_packages[*Packages*]
  - link:lab_3.adoc#_introduction_to_triggers[*Triggers*]
  - link:lab_3.adoc#_connecting_triggers_to_actions_using_rules[*Rules*]
  - link:lab_3.adoc#_creating_a_sequence_of_actions[*Sequences*]
